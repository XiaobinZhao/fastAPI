...
class MyBaseException(HTTPException):
    ...
    """
    def __init__(self, code=code.ErrorCode.INTERNAL_ERROR()["code"], message="", data={},
...
class NotFountException(MyBaseException):
    def __init__(self, *args, **keys):
        keys["code"] = keys.get("code") or code.ErrorCode.NOT_FOUND_ERROR()["code"]
...
class UnauthorizedException(MyBaseException):
    def __init__(self, *args, **keys):
        keys["code"] = keys.get("code") or code.ErrorCode.UNAUTHORIZED_ERROR()["code"]
