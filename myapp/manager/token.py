...
from myapp.base.tools import encrypt, decrypt
...
class TokenManager(object):
    ...
    def create_token(self, user: DB_User_Model):
        ...
        jwt_payload = TokenPayload(login_name=user.login_name, user_uuid=user.uuid)
        encoded_payload = encrypt(json.dumps(jwt_payload.dict()))
